...
enum PermissionEnum: string
{
    ...
    case PAYCHECK_CREATE = 'PAYCHECK.CREATE';
    case PAYCHECK_READ = 'PAYCHECK.READ';
    case PAYCHECK_READTRASHED = 'PAYCHECK.READTRASHED';
    case PAYCHECK_UPDATE = 'PAYCHECK.UPDATE';
    case PAYCHECK_DELETE = 'PAYCHECK.DELETE';
    case PAYCHECK_RESTORE = 'PAYCHECK.RESTORE';
