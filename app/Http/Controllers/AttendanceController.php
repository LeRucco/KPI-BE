...
// {
//     $selectedMonthYear = $req->date->format('Y-m');
//     $fromDate = $req->date->format('Y-m-d');        // Selected Date / Today Date
//     $toDate = $req->date->format('Y-m') . '-01';    // First Date of the Month
...
//     $totalAlpha = $this->number_of_working_days($toDate, $fromDate) - $totalAttend;
